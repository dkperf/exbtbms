...
//dk  NPRINT "Device data from %s file\n",filename);
  VPRINT "Device data from %s file\n",filename);
  flushprint();
...
//dk      NPRINT "Connect OK as LE client\n"); 
      VPRINT "Connect OK as LE client\n"); 
    else    
